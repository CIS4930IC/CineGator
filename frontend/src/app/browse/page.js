            ...
            <div className="mt-12 flex flex-col w-full">
                ...
                <form onSubmit={search}>
                    ...
                    <div className="relative flex w-1/2 mt-8 mx-auto">
                        ...
                        <button type="submit" className="text-white absolute right-2.5 bottom-2.5 focus:outline-none font-medium rounded-lg text-sm px-4 py-2 bg-red-600 hover:bg-red-700">Search</button>
                    </div>
                </form>
                {isLoading ?
